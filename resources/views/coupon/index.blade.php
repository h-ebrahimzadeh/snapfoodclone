        ...
        <div class="relative overflow-x-auto w-full mx-md-2 ">
            ...
            <table class="w-3/4 mx-auto text-xl">
                ...
                <tr class="">
                    ...
                    <th class="px-6 py-3 text-center rounded-l-lg">code</th>
                    <th class="px-6 py-3 text-center rounded-l-lg">ends at</th>
                    <th class="px-6 py-3 text-center rounded-l-lg">discount</th>
                ...
                @foreach($coupons as $coupon)
                    <tr class="border-b even:bg-blue-200">
                        ...
                        <td class="px-6 py-3 text-center">{{$coupon->code}}</td>
