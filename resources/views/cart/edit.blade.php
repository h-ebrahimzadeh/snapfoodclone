<x-app-layout>
    ...
    <div class="py-12">
        <div class="w-1/2 mt-3 mx-auto">
            <form action="{{route('seller.cart.update',$cart->id)}}" method="post" enctype="multipart/form-data">
                @csrf
                @method('put')
                ...
                <div class="mb-6">
                    ...
                    <select name="status"
                        ...
                        <option value="{{$cart->status}}" disabled>select one ...</option>
                        <option value="1">pending</option>
                        <option value="2">preparation</option>
                        <option value="3">send to destination</option>
